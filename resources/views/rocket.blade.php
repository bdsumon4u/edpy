...
<img src="https://sandbox.uddoktapay.com/assets/template/images/rocket.png" alt="Logo" class="h-[80%]">
</div>
...
<input type="text" id="maxLength" name="transaction_id" placeholder="Enter Transaction ID" class="font-english appearance-none w-full text-[15px] rounded-[10px] sm:bg-[#fbfcff] shadow shadow-[#0057d0]/5 px-5 py-3.5 placeholder-[#94A9C7] focus:outline-none focus:ring-1 focus:ring-[#0057d0]" maxlength="10" required>
